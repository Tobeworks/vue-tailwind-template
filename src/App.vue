      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div class="lg:pr-8 lg:pt-4">
          <div class="lg:max-w-lg">
            <h2 class="text-base font-semibold leading-7 text-primary-600">Deploy faster</h2>
            ...
            <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
              <div v-for="feature in features" :key="feature.name" class="relative pl-9">
                <dt class="inline font-semibold text-gray-900">
                  <component :is="feature.icon" class="absolute top-1 left-1 h-5 w-5 text-primary-600" aria-hidden="true" />
                  {{ feature.name }}
                </dt>
                {{ ' ' }}
...
<main-people></main-people>
  <main-testomonial></main-testomonial>
  <main-f-a-q></main-f-a-q>
...
import MainContact from '@/components/Main-Contact.vue';
import MainLogos from '@/components/Main-Logos.vue';
import MainFAQ from '@/components/Main-FAQ.vue';
import MainTestomonial from '@/components/Main-Testomonial.vue';
import MainPeople from '@/components/Main-People.vue';
